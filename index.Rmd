...
<a href=""><img src="../images/cover5.pdf" width="250" height="375" alt="The SCA-NS report cover" align="right" style="margin: 0 1em 0 1em; border:2px solid #008d8b"/></a>
...
```{asis index4, echo=knitr::is_latex_output()}
\mainmatter
```
...
dta <- data.frame(cases = x, lower = lb, upper = ub)

if (knitr::is_html_output()){
  DT::datatable(dta,
              rownames = FALSE,
              colnames = c("Number of Cases",
                           "Lower Bound",
                           "Upper Bound"),
              # style = "bootstrap",
        selection = 'single',
        caption = "Table of 95% confidence limits for number of cases (for 0-5 cases). Based on a Poisson distribution.",
        # width = "10px",
        extensions = "Buttons",
        options = list(
          dom = 'B<t>t',
